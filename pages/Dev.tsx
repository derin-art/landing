...
export default function Dev() {
  ...
  return (
    <div className="relative scroll-smooth dark-mode z-30 w-full h-full">
      <div className="flex flex-col relative h-screen w-full bg-black text-white items-center justify-center text-4xl font-Neue">
        <div>Ignite's Dev</div>
        <div>We love to build stuff...</div>
      </div>
      ...
      >
        <div className="absolute top-20 font-Neue text-3xl text-black lg:text-4xl lg:right-10 right-2 z-30 text-right w-4/5">
          Key partnerships with <span className="text-gray-500">companies</span>{" "}
          for unique services
