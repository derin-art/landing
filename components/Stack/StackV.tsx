...
export default function StackV() {
  ...
  return (
    <div className="h-screen w-full bg-white justify-center text-black flex flex-col p-20 items-center 2xl:text-7xl xl:text-7xl lg:text-7xl font-lora ">
          ...
          return (
            ...
            >
              <motion.button
                ...
                key={index}
                className={`text-base p-4 font-poppins hover:text-indigo-300`}
              >
